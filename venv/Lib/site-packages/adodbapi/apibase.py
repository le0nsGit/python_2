...
class FetchFailedError(OperationalError):
    ...
    failed due to a connection being closed or there is no record set returned.
    (Non-standard, added especially for django)
    """
    pass
...
class TimeConverter(object):  # this is a generic time converter skeleton
    ...
    def DateObjectToIsoFormatString(self, obj):
        """This function should return a string in the format 'YYYY-MM-dd
        HH:MM:SS:ms' (ms optional)
...
class MultiMap(dict): #builds a dictionary from {(sequence,of,keys) : function}
    """A dictionary of ado.type : function -- but you can set multiple items by
    passing a sequence of keys
    """
