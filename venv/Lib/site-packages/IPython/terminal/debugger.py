...
class TerminalPdb(Pdb):
    ...
    def pt_init(self, pt_session_options=None):
        """Initialize the prompt session and the prompt loop and store them in
        self.pt_app and self.pt_loop.

        Additional keyword arguments for the PromptSession class can be
        specified in pt_session_options.
    ...
    def cmdloop(self, intro=None):
        ...
        override the same methods from cmd.Cmd to provide prompt toolkit
        replacement.
