...
def embed_kernel(module=None, local_ns=None, **kwargs):
    ...
    Args:
        module (types.ModuleType, optional): The module to load into IPython
            globals (default: caller)
        local_ns (dict, optional): The namespace to load into IPython user
            namespace (default: caller)
        kwargs (various, optional): Further keyword args are relayed to the
            IPKernelApp constructor, allowing configuration of the Kernel. Will
            only have an effect on the first embed_kernel call for a given
            process.
    """
...
def start_ipython(argv=None, **kwargs):
    ...
    Args:
        argv (list or None, optional): If unspecified or None, IPython will
            parse command-line options from sys.argv. To prevent any
            command-line parsing, pass an empty list: `argv=[]` .
        kwargs (various, optional): Any other kwargs will be passed to the
            Application constructor, such as `config` .
    """
