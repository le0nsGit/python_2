...
class ProfileDir(LoggingConfigurable):
    ...
    def _mkdir(self, path, mode=None):
        ...
        - ignores EEXIST, protecting against race conditions where the dir may
          have been created in between the check and the creation
    ...
    def create_profile_dir(cls, profile_dir, config=None):
        ...
        Args:
            profile_dir (str): The full path to the profile directory. If it
                does exist, it will be used. If not, it will be created.
            config:
        """
    ...
    def create_profile_dir_by_name(cls, path, name=u'default', config=None):
        ...
        Args:
            path (unicode): The path (directory) to put the profile directory
                in.
            name (unicode): The name of the profile. The name of the profile
                directory will be "profile_<profile>".
            config:
        """
    ...
    def find_profile_dir_by_name(cls, ipython_dir, name=u'default', config=None):
        ...
        Args:
            ...
            name (unicode or str): The name of the profile. The name of the
                profile directory will be "profile_<profile>".
            config:
        """
