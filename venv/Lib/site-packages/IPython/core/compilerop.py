...
class CachingCompiler(codeop.Compile):
    ...
    def ast_parse(self, source, filename='<unknown>', symbol='exec'):
        ...
        Arguments are exactly the same as ast.parse (in the standard
        library), and are passed to the built-in compile function.
    ...
    def get_code_name(self, raw_code, transformed_code, number):
        ...
        Args:
            ...
            transformed_code (str): The executable Python source code to cache
                and compile.
            number (int): A number which forms part of the code's name. Used for
    ...
    def cache(self, transformed_code, number=0, raw_code=None):
        ...
        Args:
            ...
            number (int): A number which forms part of the code's name. Used for
                the execution counter.
            raw_code (str): The raw code before transformation, if None, set to
                `transformed_code` .
