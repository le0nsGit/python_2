...
def has_comment(src):
    ...
    Returns:
        bool: **comment** -- True if source has a comment.
    """
...
def ends_in_comment_or_string(src):
    ...
    Returns:
        bool: **comment** -- True if source ends in a comment or multiline
        string.
    """
...
def _strip_prompts(prompt_re, initial_re=None, turnoff_re=None):
    ...
    Args:
        ...
        initial_re (regular expression, optional): A regular expression matching
            ...
            for plain Python prompts, where the continuation prompt ``...`` is a
            valid Python expression in Python 3, so shouldn't be stripped.
        turnoff_re:
    """
