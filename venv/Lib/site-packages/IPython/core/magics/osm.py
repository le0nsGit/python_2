...
class OSMagics(Magics):
    ...
    def alias(self, parameter_s=''):
        ...
        You can use the alias facility to access all of $PATH. See the
        %rehashx function, which automatically creates aliases for the contents
        of your $PATH.

        If called with no parameters, %alias prints the current alias table
        for your system. For posix systems, the default aliases are 'cat', 'cp',
        'mv', 'rm', 'rmdir', and 'mkdir', and other platform-specific aliases
        are added. For windows-based systems, the default aliases are 'copy',
        'ddir', 'echo', 'ls', 'ldir', 'mkdir', 'ren', and 'rmdir'.
    ...
    def cd(self, parameter_s=''):
        ...
        you visit during your IPython session, in the variable _dh. The command
        ...
        Usage:
            ...
            cd -b <bookmark_name>: jump to a bookmark set by %bookmark
                (note: cd <bookmark_name> is enough if there is no
                    directory <bookmark_name>, but a bookmark with the name
                    exists.) 'cd -b <tab>' allows you to tab-complete bookmark
                    names.
    ...
    def env(self, parameter_s=''):
        ...
        Usage:\
            ...
            %env: lists all environment variables/values %env var: get value for
            var %env var val: set value for var %env var=val: set value for var
    ...
    def set_env(self, parameter_s):
        ...
        Usage:\
            %set_env var val: set value for var %set_env var=val: set value for
            var %set_env var=$val: set value for var, using python expansion if
            possible
    ...
    def dhist(self, parameter_s=''):
        ...
        %dhist -> print full history\ %dhist n -> print last n entries only\
    ...
    def sc(self, parameter_s=''):
        ...
        will then update the user's interactive namespace with a variable called
    ...
    def sx(self, line='', cell=None):
        """Shell execute - run shell command and capture output (!! is
        short-hand).
    ...
    def pycat(self, parameter_s=''):
        ...
        This magic command can either take a local filename, an url, an
        history range (see %history) or a macro as argument
    ...
    def writefile(self, line, cell):
        ...
        The file will be overwritten unless the -a (--append) flag is
        specified.
