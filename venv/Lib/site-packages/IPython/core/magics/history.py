...
class HistoryMagics(Magics):
    ...
    def history(self, parameter_s = ''):
        ...
        By default, input history is printed without line numbers so it can
        be directly pasted into an editor. Use -n to show them.
    ...
    def recall(self, arg):
        ...
        Place history line 45 on the next input prompt. Use %hist to find out
        the number.
        ...
        placed at the next input prompt. Otherwise, the history is searched for
        lines which contain that substring, and the most recent one is placed at
