...
class CrashHandler(object):
    ...
    def __init__(self, app, contact_name=None, contact_email=None,
        ...
        Args:
            app (Application): A running :class:`Application` instance, which
                will be queried at crash time for internal information.
            ...
            bug_tracker (str): A string with the URL for your project's bug
                tracker.
            show_crash_traceback (bool): If false, don't print the crash
