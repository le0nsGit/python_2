...
class EventManager(object):
    ...
    def __init__(self, shell, available_events):
        ...
        Args:
            shell: The :class:`~IPython.core.interactiveshell.InteractiveShell`
                instance
            available_events:
        """
        self.shell = shell
    ...
    def register(self, event, function):
        ...
        Args:
            ...
            function (callable): A function to be called on the given event. It
                should take the same parameters as the appropriate callback
                prototype.
    ...
    def trigger(self, event, *args, **kwargs):
        ...
        Any additional arguments are passed to all callbacks registered for
        this event. Exceptions raised by callbacks are caught, and a message
        printed.
...
def pre_run_cell(info):
    ...
    Args:
        info (~IPython.core.interactiveshell.ExecutionInfo): An object
            containing information used for the code execution.
    """
    pass
...
def post_run_cell(result):
    ...
    Args:
        result (~IPython.core.interactiveshell.ExecutionResult): The object
            which will be returned as the execution result.
    """
    pass
...
def shell_initialized(ip):
    ...
    Args:
        ip (~IPython.core.interactiveshell.InteractiveShell): The newly
            initialised shell.
    """
    pass
