...
def mpl_runner(safe_execfile):
    ...
    Args:
        safe_execfile (function): This must be a function with the same
            interface as the :meth:`safe_execfile` method of IPython.
...
def select_figure_formats(shell, formats, **kwargs):
    ...
    Args:
        ...
        formats (str or set): One or a set of figure formats to enable: 'png',
            'retina', 'jpeg', 'svg', 'pdf'.
...
def find_gui_and_backend(gui=None, gui_select=None):
    ...
    Args:
        ...
        gui_select (str): Can be one of ('tk','gtk','wx','qt','qt4','inline').
