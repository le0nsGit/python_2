...
class TestCompleter(unittest.TestCase):
    def setUp(self):
        """We want to silence all PendingDeprecationWarning when testing the
        completer
        """
    ...
    def test_latex_no_results(self):
        """forward latex should really return nothing in either field if nothing
        is found.
        """
        ip = get_ipython()
    ...
    def test_completion_have_signature(self):
        """Lets make sure jedi is capable of pulling out the signature of the
        function we are completing.
        """
        ip = get_ipython()
        with provisionalcompleter():
            ip.Completer.use_jedi = True
    ...
    def test_greedy_completions(self):
        ...
        for proof each of the text below now pass with Jedi. The greedy
        completer is capable of more.
    ...
    def test_limit_to__all__False_ok(self):
        """Limit to all is deprecated, once we remove it this test can go
        away.
        """
        ip = get_ipython()
        c = ip.Completer
    ...
    def test_magic_completion_shadowing_explicit(self):
        """If the user try to complete a shadowed magic, and explicit % start
        should still return the completions.
        """
        ip = get_ipython()
        c = ip.Completer
    ...
    def test_match_dict_keys(self):
        """Test that match_dict_keys works on a couple of use case does return
        what expected, and does not crash
        """
        delims = " \t\n`!@#$^&*()=+[{]}\\|;:'\",<>?"
    ...
    def test_tryimport(self):
        """Test that try-import don't crash on trailing dot, and import modules
        before
        """
