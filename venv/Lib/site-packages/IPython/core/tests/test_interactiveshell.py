...
class InteractiveShellTestCase(unittest.TestCase):
    ...
    def test_run_empty_cell(self):
        """Just make sure we don't get a horrible error with a blank cell of
        input. Yes, I did overlook that.
        """
    ...
    def test_dont_cache_with_semicolon(self):
        """Ending a line with semicolon should not cache the returned object
        (GH-307)
        """
    ...
    def test_bad_custom_tb(self):
        """Check that InteractiveShell is protected from bad custom exception
        handlers
        """
    ...
    def test_bad_custom_tb_return(self):
        """Check that InteractiveShell is protected from bad return types in
    ...
    def test_var_expand_self(self):
        ...
        See
        https://github.com/ipython/ipython/issues/1878#issuecomment-7698218
        """
...
class TestSafeExecfileNonAsciiPath(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.TESTDIR = join(self.BASETESTDIR, u"Ã¥Ã¤Ã¶")
        os.mkdir(self.TESTDIR)
        with open(join(self.TESTDIR, u"Ã¥Ã¤Ã¶testscript.py"), "w") as sfile:
            sfile.write("pass\n")
        self.oldpath = os.getcwd()
        os.chdir(self.TESTDIR)
        self.fname = u"Ã¥Ã¤Ã¶testscript.py"
...
class StringRejector(ast.NodeTransformer):
    ...
    Used to verify that NodeTransformers can signal that a piece of code
    should not be executed by throwing an InputRejected.
    """
...
class TestSyntaxErrorTransformer(unittest.TestCase):
    """Check that SyntaxError raised by an input transformer is handled by
    run_cell()
    """
