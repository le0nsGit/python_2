...
def passwd(passphrase=None, algorithm='sha1'):
    ...
    Args:
        passphrase (str): Password to hash. If unspecified, the user is asked to
            input and verify a password.
        algorithm (str): Hashing algorithm to use (e.g, 'sha1' or any argument
            supported by :func:`hashlib.new`).

    Returns:
        str: **hashed_passphrase** -- Hashed password, in the format
...
def passwd_check(hashed_passphrase, passphrase):
    ...
    Returns:
        bool: **valid** -- True if the passphrase matches the hash.
    """
    try:
