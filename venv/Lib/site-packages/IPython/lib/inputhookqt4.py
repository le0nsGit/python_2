...
def create_inputhook_qt4(mgr, app=None):
    ...
    Args:
        ...
        app (Qt Application, optional.): Running application to use. If not
            given, we probe Qt for an existing application object, and create a
    ...
    Notes:
        ...
        The inputhook function works in tandem with a 'pre_prompt_hook' which
        automatically restores the hook as an inputhook in case the latter has
        been temporarily disabled after having intercepted a KeyboardInterrupt.
    """
