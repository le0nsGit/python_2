...
def source_to_unicode(txt, errors='replace', skip_encoding_cookie=True):
    ...
    for the python source file encoding cookie to determine encoding. txt can be
    either a bytes buffer or a string containing the source code.
...
def read_py_file(filename, skip_encoding_cookie=True):
    ...
    Args:
        ...
        skip_encoding_cookie (bool): If True (the default), and the encoding
            declaration is found in the first two lines, that line will be
...
def read_py_url(url, errors='replace', skip_encoding_cookie=True):
    ...
    Args:
        ...
        errors (str): How to handle decoding errors in the file. Options are the
            same as for bytes.decode(), but here 'replace' is the default.
        skip_encoding_cookie (bool): If True (the default), and the encoding
            declaration is found in the first two lines, that line will be
            excluded from the output.
