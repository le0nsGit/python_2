...
def pkg_commit_hash(pkg_path):
    ...
    * git output, if we are in a git repository
    ...
    Args:
        pkg_path (str): directory containing package only used for getting
            commit from active repo
...
def pkg_info(pkg_path):
    ...
    Returns:
        dict: **context** -- with named parameters of interest
    """
...
def num_cpus():
   ...
   of available CPUs in the system, as returned by various underlying system and
   python calls.
