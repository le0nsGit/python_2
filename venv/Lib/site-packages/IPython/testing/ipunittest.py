...
class Doc2UnitTester(object):
    ...
    (though no attempt is made at turning it into a singleton, there is no need
    for that).
    """
    def __init__(self, verbose=False):
        ...
        Args:
            verbose (boolean, optional (False)): Passed to the doctest finder
                and runner to control verbosity.
        """
    ...
    def __call__(self, func):
        ...
        This version runs normal doctests, but the idea is to make it later
        run ipython syntax instead.
