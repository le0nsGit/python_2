...
class ExclusionPlugin(Plugin):
    ...
    def __init__(self, exclude_patterns=None):
        """
        Args:
            exclude_patterns (sequence of strings, optional): Filenames
                containing these patterns (as raw strings, not as regular
...
def run_iptest():
    ...
    `iptest all` . It simply calls nose with appropriate command line flags and
    accepts all of the standard nose arguments.
    """
