...
def full_path(startPath,files):
    ...
    Args:
        startPath (string): Initial path to use as the base for the results.
            This path is split using os.path.split() and only its first
            component is kept.
...
def parse_test_output(txt):
    ...
    Args:
        txt (str): Text output of a test run, assumed to contain a line of one
...
def ipexec(fname, options=None, commands=()):
    ...
    Args:
        fname (str): Name of file to be executed (should have .py or .ipy
            extension).
        options (optional, list): Extra command-line flags to be passed to
            IPython.
...
def ipexec_validate(fname, expected_out, expected_err='',
    ...
    Args:
        fname (str): Name of the file to be executed (should have .py or .ipy
            extension).
...
def check_pairs(func, pairs):
    ...
    Args:
        func (callable): The function to be tested. Should accept a single
            argument.
