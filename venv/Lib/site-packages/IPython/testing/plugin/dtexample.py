...
def ipfunc():
    ...
    numbered history of _NN outputs, since those won't exist under the doctest
    environment:
...
def ranfunc():
    ...
    But if you put '# random' in the output, it is ignored: >>> 1+3 junk goes
    here... # random
...
def random_all():
    ...
    Examples:
        ...
        executed, so if a they raise an error, it will be detected as such, but
        their output is completely ignored.
