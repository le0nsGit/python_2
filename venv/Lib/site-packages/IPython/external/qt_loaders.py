...
class ImportDenier(object):
    """Import Hook that will guard against bad Qt imports once IPython commits
...
def loaded_api():
    ...
    If this returns anything besides None, importing any other Qt binding is
    unsafe.
...
def has_binding(api):
    ...
    Args:
        api (str [ 'pyqtv1' | 'pyqt' | 'pyqt5' | 'pyside' | 'pyside2' | 'pyqtdefault']): Which module to check for
...
def import_pyqt4(version=2):
    ...
    Args:
        version (1, 2, or None): Which QString/QVariant API to use. Set to None
...
def load_qt(api_options):
    ...
    Args:
        api_options (List of strings): The order of APIs to try. Valid items are
            'pyside', 'pyside2', 'pyqt', 'pyqt5', 'pyqtv1' and 'pyqtdefault'
