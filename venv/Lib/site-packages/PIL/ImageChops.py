...
def soft_light(image1, image2):
    """Superimposes two images on top of each other using the Soft Light
    algorithm
...
def hard_light(image1, image2):
    """Superimposes two images on top of each other using the Hard Light
    algorithm
...
def logical_and(image1, image2):
    ...
    :py:meth:`~PIL.ImageChops.multiply` instead, using a black-and-white mask as
    the second image.
...
def offset(image, xoffset, yoffset=None):
    ...
    Args:
        ...
        yoffset: The vertical distance. If omitted, both distances are set to
            the same value.
    """
